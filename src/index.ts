...
import { GitlabHelper, GitLabIssue, GitLabMilestone } from './gitlabHelper.js';
...
async function transferLabels(attachmentLabel = true, useLowerCase = true) {
  ...
  const invalidUnicode = new RegExp("/[\u{10000}-\u{10FFFF}]|(?![*#0-9]+)[\p{Emoji}\p{Emoji_Modifier}\p{Emoji_Component}\p{Emoji_Modifier_Base}\p{Emoji_Presentation}]/", "gu");
